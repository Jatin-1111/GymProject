...
function Page() {
    ...
    return (
        <div className="min-h-screen bg-black">
            ...
            <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-bl from-gray-900 via-black to-red-900/20 relative">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-10 sm:mb-12 md:mb-16">
                        <h2 className="text-2xl font-[Almendra] sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-6">
                            OUR <span className="text-red-500 font-[Almendra]">TRAINERS</span>
                        </h2>
                        <p className="text-sm sm:text-base md:text-lg font-[Poppins] lg:text-xl text-gray-400 max-w-3xl mx-auto px-4">
                    ...
                    <div className="relative">
                                    ...
                                    >
                                        <div className="bg-black p-3 sm:p-4 md:p-6 rounded-lg sm:rounded-xl border border-gray-800 hover:border-red-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl group">
                                            ...
                                            <div className="text-center">
                                                <h3 className="text-lg font-[Poppins] sm:text-xl md:text-2xl font-bold text-white group-hover:text-red-500 transition-colors duration-300">
                                                    {trainer.name}
                                                </h3>
                                            </div>
                                        </div>
                        ...
                        <div className="flex justify-center mt-6 sm:mt-8 space-x-2">
                            {trainers.map((_, index) => (
                                <button
                                    ...
                                    className={`w-2.5 h-2.5 font-[Poppins] sm:w-3 sm:h-3 rounded-full transition-all duration-300 ${
                                        index === currentIndex 
                        ...
                        <div className="text-center mt-3 sm:mt-4">
                            <span className="text-gray-400 font-[Poppins] text-xs sm:text-sm md:text-base">
            ...
            {/* Stats Section */}
            <section className=" bg-gradient-to-r from-red-900/10 via-black to-gray-900/50 relative mb-20">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-3 gap-4 sm:gap-6 text-center px-4 sm:px-6 md:px-10 lg:mx-20">
                        <div className="bg-black/20 p-3 sm:p-4 md:p-6 rounded-lg">
                            ...
                            <div className="text-gray-400 font-[Poppins] font-semibold text-xs sm:text-sm md:text-base leading-tight">
                                CERTIFIED<br className="sm:hidden font-[Poppins]" /> TRAINERS
                            </div>
                        </div>
                        <div className="bg-black/20 p-3 sm:p-4 md:p-6 rounded-lg">
                            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-red-500 mb-1 sm:mb-2">500+</div>
                            <div className="text-gray-400 font-[Poppins] font-semibold text-xs sm:text-sm md:text-base leading-tight">
                                MEMBERS<br className="sm:hidden font-[Poppins]" /> TRAINED
                            </div>
                        </div>
                        <div className="bg-black/20 p-3 sm:p-4 md:p-6 rounded-lg">
                            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-red-500 mb-1 sm:mb-2">15+</div>
                            <div className="text-gray-400 font-[Poppins] font-semibold text-xs sm:text-sm md:text-base leading-tight">
                                SPECIAL<br className="sm:hidden font-[Poppins]" />IZATIONS
                            </div>
                        </div>
                    </div>
                </div>
