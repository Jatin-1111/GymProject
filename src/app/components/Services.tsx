...
//             <section className="py-16 bg-gradient-to-r from-red-900/10 via-black to-gray-900/50 relative">
...
//                             <div
//                                 key={service.id}
//                                 className="bg-gradient-to-br from-gray-900 to-black px-6 py-15 border border-gray-800 group"
//                             >
...
//                             <div
//                                 key={item.id}
//                                 className="bg-gradient-to-br from-gray-900 to-black rounded-xl border border-gray-800 overflow-hidden group cursor-pointer relative h-60 sm:h-75"
//                             >
...
//                                         <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white text-center px-4 drop-shadow-2xl">
//                                             {item.name}
//                                         </h3>
//                                     </div>
//                                 </div>
...
//                                 <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col items-center justify-center p-6">
//                                     <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-red-500 mb-4 sm:mb-6 text-center">
//                                         Effective Parts
//                                     </h3>
//                                     <div className="text-sm sm:text-base lg:text-lg text-white font-medium text-left">
...
//                     <div className="grid md:grid-cols-2 lg:grid-cols-4 mx-20">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 px-4 sm:px-6 md:px-10 lg:mx-20">
                        {services.map((service) => (
                            <div
                                key={service.id}
                                className="bg-gradient-to-br from-gray-900 to-black p-4 sm:p-6 md:py-8 lg:py-15 border border-gray-800 group rounded-lg sm:rounded-none"
                            >
                                <div className="text-center mb-4">
                                    <h3 className="text-lg sm:text-xl font-bold text-white group-hover:text-red-500 transition-colors duration-300">
                                        {service.title}
                                    </h3>
                                    <p className="text-sm sm:text-base text-gray-400 mt-2">{service.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-12 sm:py-16 md:py-20 bg-black relative">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-10 sm:mb-12 md:mb-16">
                        ...
                        <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-400 max-w-3xl mx-auto px-4">
                            State-of-the-art machinery designed for maximum results and safety
                        </p>
                    </div>
                            ...
                            >
                                ...
                                <div className="absolute inset-0 group-hover:opacity-0 transition-opacity duration-500">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center p-2">
                                        <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-white text-center px-2 sm:px-4 drop-shadow-2xl">
                                            {item.name}
                                        </h3>
                                    </div>
                                </div>
                                ...
                                <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col items-center justify-center p-3 sm:p-4 md:p-6">
                                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold text-red-500 mb-3 sm:mb-4 md:mb-6 text-center">
                                        Effective Parts
                                    </h3>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4  px-4 sm:px-6 md:px-10 lg:mx-20">
                        <div className="text-center p-4 sm:p-6 bg-black rounded-lg sm:rounded-none">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">24/7 Access</h3>
                            <p className="text-sm sm:text-base text-gray-400">Train anytime with round-the-clock facility access</p>
                        </div>
                        ...
                        <div className="text-center p-4 sm:p-6 bg-black rounded-lg sm:rounded-none">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Safety First</h3>
                            <p className="text-sm sm:text-base text-gray-400">Advanced safety features and emergency protocols</p>
                        </div>
                        ...
                        <div className="text-center p-4 sm:p-6 bg-black rounded-lg sm:rounded-none">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Latest Tech</h3>
                            <p className="text-sm sm:text-base text-gray-400">Cutting-edge equipment with smart technology</p>
                        </div>
                        ...
                        <div className="text-center p-4 sm:p-6 bg-black rounded-lg sm:rounded-none">
                            ...
                            <p className="text-sm sm:text-base text-gray-400">Professional trainers always available for guidance</p>
                        </div>
                    </div>
                </div>
            </section>
